...
class CampaignToNumberTransformer implements DataTransformerInterface
{
    private $entityManager;

    /**
     * CampaignToNumberTransformer constructor.
     * @param $entityManager
     */
...
//        dd('transform', $campaign);
     ...
     * @throws TransformationFailedException when the transformation fails
     */
    public function reverseTransform($campaignIdk)


    {

//        dd('rev transform', $campaignIdk);
        if(!$campaignIdk){
            return;
        }
